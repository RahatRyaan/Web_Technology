...
<html>
<head>
    <title>Programming Judge - Problem Submission</title>
</head>
<body>
    <?php 
                ...
                <table>
                    <form action="" method="POST" enctype="multipart/form-data">
                        <tr>
                            ...
                            <td><input type="text" id="problem_title" name="problem_title"></td>
                        </tr>
                        <tr>
                            <th><label for="problem_statement">Problem Statement:</label></th>
                            <td><textarea id="problem_statement" name="problem_statement" rows="10" cols="50"></textarea></td>
                        </tr>
                        <tr>
                            <th><label for="sample_input">Sample Input:</label></th>
                            <td><input type="file" id="sample_input" name="sample_input" accept=".in"></td>
                        </tr>
                        <tr>
                            <th><label for="sample_output">Sample Output:</label></th>
                            <td><input type="file" id="sample_output" name="sample_output" accept=".out"></td>
                        </tr>
                        <tr>
                            <th><label for="test_case_1_input">Test Case #1 Input:</label></th>
                            <td><input type="file" id="test_case_1_input" name="test_case_1_input" accept=".in"></td>
                        </tr>
                        <tr>
                            <th><label for="test_case_1_output">Test Case #1 Output:</label></th>
                            <td><input type="file" id="test_case_1_output" name="test_case_1_output" accept=".out"></td>
                        </tr>
                        <tr>
                            <th><label for="solution">Solution:</label></th>
                            <td><input type="file" id="solution" name="solution" accept=".txt"></td>
                        </tr>
                        <tr>
