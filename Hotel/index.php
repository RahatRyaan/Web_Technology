...
<html lang="en">
<head>
<title>RAHATHASAN HOTEL</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Resort Inn Responsive , Smartphone Compatible web template , SamRAHATg, LG, Sony Ericsson, Motorola web design" />
...
<div class="banner-top">
            ...
            <div class="contact-bnr-w3-agile">
                <ul>
                    <li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@RAHAT.COM</a></li>
                    <li><i class="fa fa-phone" aria-hidden="true"></i>+880 1745504798</li>  
                    <li class="s-bar">
                        <div class="search">
        ...
        <div class="container">
            <nav class="navbar navbar-default">
                <div class="navbar-header navbar-left">
                    ...
                    <h1><a class="navbar-brand" href="index.php">Rahat <span>Hasan</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
                </div>
                ...
                <ul class="cbp-ig-grid">
                    <li>
                        <div class="w3_grid_effect">
                            ...
                            <span class="cbp-ig-category">RAHAT HASAN</span>
                        </div>
                    </li>
                    <li>
                        <div class="w3_grid_effect">
    ...
    <div class="about-wthree" id="about">
          <div class="container">
                   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our RAHAT HASAN</h3> 
...
<section class="contact-w3ls" id="contact">
    <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
            ...
            <p class="contact-agile1"><strong>Phone :</strong>+88174554798</p>
            <p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@RAHATHASAN.COM</a></p>
            <p class="contact-agile1"><strong>Address :</strong> KURIL,DHAKA,BANGLADESH</p>
            ...
            <iframe src="https://www.google.com/maps/place/Hotel+Safa+Residency/@23.8316896,90.4120205,16z/data=!4m12!1m2!2m1!1sHotels!3m8!1s0x3755c70009b1b5f9:0xe85ebc5748258109!5m2!4m1!1i2!8m2!3d23.8355313!4d90.4171514!16s%2Fg%2F11w7l6xxr4?entry=ttu&g_ep=EgoyMDI0MTIxMS4wIKXMDSoASAFQAw%3D%3D" ></iframe>
        </div>
        <div class="clearfix"></div>
    </div>
</section>
<!-- /contact -->
            <div class="copy">
                <p>© 2017 RAHATHASAN . All Rights Reserved | Design by <a href="index.php">RAHATHASAN</a> </p>
            </div>
<!--/footer -->
<!-- js -->
